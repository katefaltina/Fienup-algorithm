...
// IT_5.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIT5App, CWinApp)
...
// Единственный объект CIT5App

CIT5App theApp;


// Инициализация CIT5App

BOOL CIT5App::InitInstance()
{
